    ...
    <div class="wrapper">
        ...
        <div class="sidebar-wrapper" data-simplebar="true">
            <div class="sidebar-header">
                <div>
                    <img src="<?php echo BASE_URL; ?>assets/images/logohead.png" class="logo-icon" alt="logo icon">
                </div>
                <div>
                    <h4 class="logo-text">Restaurante la osa</h4>
                </div>
            ...
            <ul class="metismenu" id="menu">
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li> <a href="<?php echo BASE_URL . 'admin/datos'; ?>"><i class="bx bx-right-arrow-alt"></i>Empresa</a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul>
                        <li> <a href="<?php echo BASE_URL . 'medidas'; ?>"><i class="bx bx-right-arrow-alt"></i>Estado</a>
                        </li>
                ...
                <nav class="navbar navbar-expand">
                    ...
                    <div class="user-box dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            ...
                            <li><a class="dropdown-item" href="http://localhost/pos/"><i class='bx bx-log-out-circle'></i><span>Logout</span></a>
                            </li>
                        </ul>
                    </div>
                </nav>
